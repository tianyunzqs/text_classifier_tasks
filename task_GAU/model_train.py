...
from task_GAU.gau_models import GAU_alpha
...
def load_pre_model(model_name='bert'):
    """
    :param model_name: bert、bert-wwm、albert、roberta、roberta-wwm、nezha、t5、gau
    :return:
    """
    if model_name == 'bert':
        ...
        config_path = '/home/zqs/pre_train_models/chinese_GAU-alpha-char_L-24_H-768/bert_config.json'
        checkpoint_path = '/home/zqs/pre_train_models/chinese_GAU-alpha-char_L-24_H-768/bert_model.ckpt'
        dict_path = '/home/zqs/pre_train_models/chinese_GAU-alpha-char_L-24_H-768/vocab.txt'
        _model = GAU_alpha
    else:
        raise Exception("not support yet.")
    # 建立分词器
...
tokenizer, bert = load_pre_model(model_name='gau')
