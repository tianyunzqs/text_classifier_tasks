...
from task_BiLSTM_Attention.data_helper import Vocab, CategeoryDict, TextDataSet, compute_p_r_f
from task_BiLSTM_Attention.text_lstm import TextLSTM
...
lstm = TextLSTM(sequence_length=FLAGS.num_timesteps,
