...
def train_model(train_data, test_data):
    ...
    # 训练模型
    svm_cls = SVC(C=1, kernel='rbf', gamma='auto').fit(train_tfidf, train_y)
    pickle.dump((vectorizer, transformer, svm_cls), open("./model.pickle", "wb"))
    ...
    for cls, data in test_data.items():
        for d in data:
            ...
            prediction = svm_cls.predict(test_tfidf)[0]
