...
from task_RCNN.data_helper import Vocab, CategeoryDict, TextDataSet, compute_p_r_f
...
lstm = TextRCNN(vocab_size=vocab_size,
                num_embedding_size=FLAGS.embedding_size,
                num_lstm_nodes=FLAGS.num_lstm_nodes,
                num_classes=num_classes,
                representation_output_size=FLAGS.representation_output_size)
